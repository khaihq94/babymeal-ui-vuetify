...
import DishModelMapper from '@/mapper/DishModelMapper'
    ...
    save() {
      if (this.isEditing) {
        request({
          url: this.baseApiUrl + '/' + this.$route.params.id,
          method: 'put',
          data: DishModelMapper.toModelForEditing(this.$route.params.id, this.contents),
        })
          .then(() => {
        ...
        request({
          url: this.baseApiUrl,
          method: 'post',
          data: DishModelMapper.toModelForCreation(this.contents),
        })
          .then(() => {
